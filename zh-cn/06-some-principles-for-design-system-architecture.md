...
![访问统计](https://visitor-badge.glitch.me/badge?page_id=senlypan.qa.06-some-principles-for-design-system-architecture&left_color=blue&right_color=red)

> 作者: 陈皓 
>
> 创建: 2021-12-21

![](../_media/images/21-some-principles-for-design-system-architecture/bg.png)

原链：[《我做系统架构的一些原则》](https://coolshell.cn/articles/21672.html)
...
对于 [X-Y](https://coolshell.cn/articles/10804.html) 问题，也就是说，用户为了解决 X问题，他觉得用 Y 可以解，于是问我 Y 怎么搞，结果搞到最后，发现原来要解决的 X 问题，这个时候最好的解决方案不是 Y，而是 Z。 这种 X-Y 问题真是相当之多，见的太多太多了。所以，每次用户来找我的时候，我都要不断地追问什么是 X 问题。
